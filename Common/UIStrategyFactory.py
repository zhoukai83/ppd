...
class UIStrategyFactory(StrategyFactory):
    ...
    def __init__(self, logger=None):
        ...
        base_strategy1.add_filters([
            ...
            ["逾期（0-15天）还清次数", "==", "0", "int"],
            ["成功还款次数", ">", "40", "int"],                     # 40 - 60
            ["本次借款后负债/历史最高负债", "<", "0.96", "rate"],  # 0.7 - 0.96
        ...
        base_strategy2.add_filters([
            ...
            ["本次借款后负债/历史最高负债", "<", "0.97", "rate"],  # 0.7 - 0.96
        ...
        base_strategy_c1 = strategy_class("零逾C", ">60")
        base_strategy_c1.add_filters([
            ...
            ["逾期（0-15天）还清次数", "==", "0", "int"],
            ["成功还款次数", ">", "60", "int"],  # 40 - 60
            ["本次借款后负债/历史最高负债", "<", "0.89", "rate"],  # 0.7 - 0.96
            ["借款金额/单笔最高借款金额", "<", "0.92", "rate"],
            ["网络借贷平台借款余额", "<", "1", "int"]  # 8000 - 10000
        ])
        self.strategy_list.append(base_strategy_c1)

        # base_strategy_a1 = strategy_class("低逾A", "")
