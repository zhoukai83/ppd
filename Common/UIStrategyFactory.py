...
class UIStrategyFactory(StrategyFactory):
    ...
    def __init__(self, logger=None):
        ...
        base_strategy2.add_filters([
            ...
            ["成功还款次数", ">", "25", "int"],             # 30 - 40
            ["文化程度", "!=", "无", "str"],
            ["逾期（0-15天）还清次数/成功还款次数", "<", "0.1", "rate"],  # 0.05
        ...
        base_strategy3.add_filters([
            ...
            ["成功还款次数", ">", "35", "int"],
            ["本次借款后负债/历史最高负债", "<", "1", "rate"],  # 0.7 - 0.95
            ["借款金额/单笔最高借款金额", "<", "1", "rate"],
            ["网络借贷平台借款余额", "<", "9000", "int"]
        ])
        ...
        base_strategy_a1.add_filters([
            ...
            ["成功还款次数", ">", "25", "int"],  # 20 - 60
            ["本次借款后负债/历史最高负债", "<", "1.01", "rate"],  # 0.7 - 1
            ["借款金额/单笔最高借款金额", "<", "1.01", "rate"],
            ["网络借贷平台借款余额", "<", "10000", "int"]  # 8000 - 10000
        ])
        ...
        base_strategy_a_3.add_filters([
            ...
            ["期限", "==", "3", "int"],
            ["逾期（15天以上）还清次数", "==", "0", "int"],
            # ["逾期（0-15天）还清次数/成功还款次数", "<", "0.2", "rate"],
            ["成功还款次数", ">", "10", "int"],  # 20 - 60
            # ["本次借款后负债/历史最高负债", "<", "1.1", "rate"],  # 0.7 - 1
            # ["借款金额/单笔最高借款金额", "<", "1.1", "rate"],
            # ["网络借贷平台借款余额", "<", "11000", "int"]  # 8000 - 10000
        ])
