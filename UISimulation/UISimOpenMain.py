...
def main():
    ...
    data_file_path = "UISimOpenMain.csv"
    ...
    with FetchFromChrome(config["Session"]) as fetch_from_chrome:
        ...
        while config["Terminate"] == "False":
            ...
            try:
                ...
                listing_detail_list = ppd_open_client.batch_get_listing_info(listing_ids)
                ...
                listing_detail_list = [ppd_convertor.convert_open_to_ui(item) for item in listing_detail_list if item]
