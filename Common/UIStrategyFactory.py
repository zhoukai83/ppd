...
class UIStrategyFactory(StrategyFactory):
    def __init__(self, logger=None):
        ...
        base_strategy1.add_filters([
            ...
            ["网络借贷平台借款余额", "<", "9000", "int"]            # 8000 - 10000
        ])
        self.strategy_list.append(base_strategy1)

        base_strategy2 = strategy_class("女学历  ", "逾期<5")
        ...
        base_strategy3 = strategy_class("低逾期 ", "<0.02")
        base_strategy3.add_filters([
            ...
            ["成功还款次数", ">", "40", "int"],
            ["本次借款后负债/历史最高负债", "<", "0.97", "rate"],  # 0.7 - 0.95
            ["网络借贷平台借款余额", "<", "8000", "int"]
        ])
        self.strategy_list.append(base_strategy3)

        base_strategy_c1 = strategy_class("零逾期C ", ">60")
